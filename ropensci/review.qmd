...
Thank you for submitting this package, it's fabulous! I can also see that a lot of work has gone into this.
...
-   In the package's current state, you have to type the whole standard out before the conversion. I think I would be thinking about the conversion first, for example: `val2z`, `val2centile`, `z2val`, and `centile2val`, then the standard name can be an option in the function call?
